...
- FR-2: The SSD1306 OLED display (128x64, I2C) showed game prompts, card names, and stage information.
...
- FR-5: LED matrix displays (HT16K33-based) showed gem counts and score totals, multiplexed through a TCA9548A I2C mux.
