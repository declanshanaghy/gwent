...
Generates images using Google's Gemini API. A project-specific base prompt from `base-prompt.md` is automatically prepended to all prompts, applying the Gwent Companion visual style (dark fantasy, burgundy/gold palette, Witcher III aesthetic).
