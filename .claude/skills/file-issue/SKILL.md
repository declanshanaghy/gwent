...
Example:
```
Filed #1 — "Rotary button fires duplicate OK events"
Labels: bug, high
https://github.com/declanshanaghy/gwent/issues/1
```

## Rules

- **All questions to the user MUST use `AskUserQuestion`** — never output a question as plain text. This includes: ambiguous type/priority, duplicate confirmation, and any other user input needed.
