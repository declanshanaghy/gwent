...
- Game state dump: `mosquitto_sub -h localhost -u geralt -P gwent -t gwent/server/state -C 1` (or `/game-state`)
- Games always start from freshly generated decks — there are no recordings/snapshots
